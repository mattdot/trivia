...
- **Re-route so the answer is a bounded set — and the bounded set can be _anything_ enumerable, not just countries.** Not "which scientist won X" but "which *country* has produced the most X winners"; not "which animal lives longest" but "which *country* protects the most of them." Countries are the common workhorse, but the answer set can be U.S. states, continents, the planets, the oceans, the days or months, a league's teams, the colors of the rainbow, even a small count ("how many of them can roar?" → four). **Vary the answer set across the game** — the cluster rule applies here too: a set where every answer is a country is its own quiet monotony, the same failure as a set where every dimension was "sales." Reach for whichever enumerable set the question naturally lands on, and rotate through several over a round, with the rich subject riding along as what's being measured.
